...
const file_proto_greet_proto_rawDesc = "" +
	"\n" +
	"\x11proto/greet.proto\x12\fgreetService\"\t\n" +
	"\aNoParam\")\n" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\xa6\x02\n" +
	"\fGreetService\x12>\n" +
	"\bSayHello\x12\x15.greetService.NoParam\x1a\x1b.greetService.HelloResponse\x12B\n" +
	"\bHelloSSR\x12\x17.greetService.NamesList\x1a\x1b.greetService.HelloResponse0\x01\x12D\n" +
	"\bHelloCSR\x12\x1b.greetService.HelloResponse\x1a\x19.greetService.MessageList(\x01\x12L\n" +
	"\rBidirectional\x12\x1a.greetService.HelloRequest\x1a\x1b.greetService.HelloResponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_goTypes = []any{
	(*NoParam)(nil),       // 0: greetService.NoParam
	(*HelloResponse)(nil), // 1: greetService.HelloResponse
	(*HelloRequest)(nil),  // 2: greetService.HelloRequest
	(*NamesList)(nil),     // 3: greetService.NamesList
	(*MessageList)(nil),   // 4: greetService.MessageList
}
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: greetService.GreetService.SayHello:input_type -> greetService.NoParam
	3, // 1: greetService.GreetService.HelloSSR:input_type -> greetService.NamesList
	1, // 2: greetService.GreetService.HelloCSR:input_type -> greetService.HelloResponse
	2, // 3: greetService.GreetService.Bidirectional:input_type -> greetService.HelloRequest
	1, // 4: greetService.GreetService.SayHello:output_type -> greetService.HelloResponse
	1, // 5: greetService.GreetService.HelloSSR:output_type -> greetService.HelloResponse
	4, // 6: greetService.GreetService.HelloCSR:output_type -> greetService.MessageList
	1, // 7: greetService.GreetService.Bidirectional:output_type -> greetService.HelloResponse
